...
<div class="container">
  <div class="row">
    ...
    <div class="col-sm-4" style="padding:30px;">
	   <div class="form-group">
           <i class="fa fa-phone" aria-hidden="true"></i>&nbsp;<b>+937842341235</b><br><br>
			<i class="fa fa-home" aria-hidden="true"></i>&nbsp; KBL-A ,North-East Street,Share-Naw,Kabul Zip Code-10001<br>(24*7 Days)
